...
public class StandardEngine extends ContainerBase implements Engine {
    ...
    private static final Logger log = LogManager.getLogger(org.apache.catalina.core.StandardEngine.class);
    ...
    protected static final class AccessLogListener
        ...
        public AccessLogListener(org.apache.catalina.core.StandardEngine engine, Host host,
                                 Context context) {
            this.engine = engine;
            this.host = host;
