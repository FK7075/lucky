...
public abstract class AbstractProtocol<S> implements ProtocolHandler,
        MBeanRegistration {
    private static final Logger log = LogManager.getLogger(org.apache.coyote.AbstractProtocol.class);

    /**
     * The string manager for this package.
     */
    private static final StringManager sm = StringManager.getManager(org.apache.coyote.AbstractProtocol.class);
    ...
    protected static class ConnectionHandler<S> implements Handler<S> {
        ...
        public ConnectionHandler(org.apache.coyote.AbstractProtocol<S> proto) {
            this.proto = proto;
        }
