...
public class HttpParser {
    ...
    private static final StringManager sm = StringManager.getManager(org.apache.tomcat.util.http.parser.HttpParser.class);

    private static final Log log = LogFactory.getLog(org.apache.tomcat.util.http.parser.HttpParser.class);
    ...
    static {
        ...
        DEFAULT = new org.apache.tomcat.util.http.parser.HttpParser(null, null);
    }
